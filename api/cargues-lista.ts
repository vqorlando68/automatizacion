...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    return res.status(200).json({
      success: true,
      cargues: [
        { id: 1001, nombre_archivo: 'cargue_usuarios_piloto.csv', fecha_cargue: '2026-07-14 15:30:12', tiene_encabezado: 'S', estado: 'C', id_entidad: 11, id_convenio: 101, id_regimen_aseguramiento: 1, usuario: 'admin' },
        { id: 1002, nombre_archivo: 'usuarios_medicos.xlsx', fecha_cargue: '2026-07-14 16:12:45', tiene_encabezado: 'S', estado: 'C', id_entidad: 20, id_convenio: 301, id_regimen_aseguramiento: 2, usuario: 'admin' }
      ]
    });
  }
}
