              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full px-4 py-3 pr-12 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-sm focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 text-slate-900 dark:text-white transition-all duration-200 placeholder-slate-400"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1.5 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors cursor-pointer rounded-lg hover:bg-slate-200/50 dark:hover:bg-slate-800/50"
                  ...
                  >
                    {showPassword ? (
                      ...
                      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12c1.349-3.638 5.06-6.3 9.964-6.3s8.615 2.662 9.964 6.3c-1.349 3.638-5.06 6.3-9.964 6.3s-8.615-2.662-9.964-6.3z" />
            ...
            <div className="space-y-6">
                  ...
                  {cargueSubTab === 'nuevo' && (
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-950 p-4 border border-slate-200 dark:border-slate-800 rounded-xl mb-4 overflow-x-auto">
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${wizardStep === '1' ? 'bg-indigo-600 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>1</span>
                        <span className={`text-xs whitespace-nowrap ${wizardStep === '1' ? 'font-bold text-indigo-600 dark:text-indigo-400' : 'font-medium text-slate-600 dark:text-slate-400'}`}>Seleccionar Archivo</span>
                        <span className="text-slate-400 dark:text-slate-600">→</span>
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${wizardStep.startsWith('2') ? 'bg-indigo-600 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>2</span>
                        <span className={`text-xs whitespace-nowrap ${wizardStep.startsWith('2') ? 'font-bold text-indigo-600 dark:text-indigo-400' : 'font-medium text-slate-600 dark:text-slate-400'}`}>Configuración</span>
                        <span className="text-slate-400 dark:text-slate-600">→</span>
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${wizardStep === '3' ? 'bg-indigo-600 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>3</span>
                        <span className={`text-xs whitespace-nowrap ${wizardStep === '3' ? 'font-bold text-indigo-600 dark:text-indigo-400' : 'font-medium text-slate-600 dark:text-slate-400'}`}>Verificación</span>
                        <span className="text-slate-400 dark:text-slate-600">→</span>
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${wizardStep === '4' ? 'bg-indigo-600 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>4</span>
                        <span className={`text-xs whitespace-nowrap ${wizardStep === '4' ? 'font-bold text-indigo-600 dark:text-indigo-400' : 'font-medium text-slate-600 dark:text-slate-400'}`}>Resultado</span>
                      </div>
              ...
              {currentTab === 'crear_usuarios' && (
                <div className="space-y-6">
                  ...
                  {/* Pasos del Wizard */}
                  <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-950 p-4 border border-slate-200 dark:border-slate-800 rounded-xl mb-4 overflow-x-auto">
                    <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${userWizardStep === '1' ? 'bg-indigo-600 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>1</span>
                    <span className={`text-xs whitespace-nowrap ${userWizardStep === '1' ? 'font-bold text-indigo-600 dark:text-indigo-400' : 'font-medium text-slate-600 dark:text-slate-400'}`}>Seleccionar Cargue</span>
                    <span className="text-slate-400 dark:text-slate-600">→</span>
                    <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${userWizardStep === '2' ? 'bg-indigo-600 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>2</span>
                    <span className={`text-xs whitespace-nowrap ${userWizardStep === '2' ? 'font-bold text-indigo-600 dark:text-indigo-400' : 'font-medium text-slate-600 dark:text-slate-400'}`}>Equivalencias</span>
                    <span className="text-slate-400 dark:text-slate-600">→</span>
                    <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${userWizardStep === '3' ? 'bg-indigo-600 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>3</span>
                    <span className={`text-xs whitespace-nowrap ${userWizardStep === '3' ? 'font-bold text-indigo-600 dark:text-indigo-400' : 'font-medium text-slate-600 dark:text-slate-400'}`}>Homologaciones</span>
                    <span className="text-slate-400 dark:text-slate-600">→</span>
                    <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${userWizardStep === '4' ? 'bg-indigo-600 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>4</span>
                    <span className={`text-xs whitespace-nowrap ${userWizardStep === '4' ? 'font-bold text-indigo-600 dark:text-indigo-400' : 'font-medium text-slate-600 dark:text-slate-400'}`}>Validar y Confirmar</span>
                    <span className="text-slate-400 dark:text-slate-600">→</span>
                    <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${userWizardStep === '5' ? 'bg-indigo-600 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>5</span>
                    <span className={`text-xs whitespace-nowrap ${userWizardStep === '5' ? 'font-bold text-indigo-600 dark:text-indigo-400' : 'font-medium text-slate-600 dark:text-slate-400'}`}>Resultado</span>
                  </div>
